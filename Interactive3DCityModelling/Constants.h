...
namespace icm {
	...
	static const std::vector<float> street_mesh_ambient = { .45f, .45f, 0.45f, 1.0f };
	static const std::vector<float> street_mesh_diffuse = { .45f, .45f, 0.45f, 1.0f };
	...
	static const std::vector<float> building_ambient = { 0.5f, 0.0f, 0.0f, 1.0f };
	static const std::vector<float> building_diffuse = { 0.5f, 0.0f, 0.0f, 1.0f, };
